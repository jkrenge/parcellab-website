        ...
        >
          {cards.map((card) => (
            ...
            >
              ...
              {/* CTA */}
              <a
                href={`${import.meta.env.BASE_URL}/${card.id === "retain" ? "make-returns-seamless" : card.id === "engage" ? "enhance-delivery-experience" : card.id === "convert" ? "boost-cart-conversion" : card.id === "insights" ? "get-data-driven-insights" : "ai-powered-post-purchase"}/`}

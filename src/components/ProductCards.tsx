...
const cards: ProductCard[] = [
  {
    ...
    bgColor: "bg-[#EF4444]",
    pillColor: "bg-[#EF4444]",
    image: "/images/parcellab-returns-solution-retain.webp",
  ...
  },
  {
    ...
    bgColor: "bg-[#FFC943]",
    pillColor: "bg-[#FFC943]",
    image: "/images/parcellab-engage-delivery-notifications-tracking-page.webp",
  ...
  },
  {
    ...
    bgColor: "bg-[#035740]",
    pillColor: "bg-[#035740]",
    image: "/images/parcellab-engage-estimated-delivery-date.webp",
  ...
  },
  {
    ...
    bgColor: "bg-[#5046E5]",
    pillColor: "bg-[#5046E5]",
    image: "/images/parcellab-data-logistics-analytics.webp",
  ...
  },
  {
    ...
    bgColor: "bg-[#1e1b4b]",
    pillColor: "bg-[#1e1b4b]",
    image: "/images/parcellab-AI-shipping-artificial-intelligence.webp",
